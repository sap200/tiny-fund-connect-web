        ...
        <div id="left-pane">
            <div id="signup-form">
                ...
                <form id="signup-form-1" @submit.prevent>
                    ...
                    <Button id="signup-button" @click="verifyLoginMfa" :disabled="isOtpEmpty"> Verify OTP </Button>
                </form>
...
export default {
    ...
    methods: {
        async verifyLoginMfa() {
            ...
            let apiPath = HOST+"/login/complete"
            ...
            try {
                ...
                // redirect to dashboard which is nnot yet prepared
