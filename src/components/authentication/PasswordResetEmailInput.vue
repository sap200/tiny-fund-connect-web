    ...
    <div id="container">
        ...
        <div id="left-pane">
            <div id="signup-form">
                ...
                <p id="verify-text"> <i><b> Enter your account's email </b></i> </p><br>
                <form id="signup-form-1" @submit.prevent>
                    <label id="email"> <b>Email</b> </label><br>
                    <input type="text" required v-model="emailId"/><br><br><br>
                    <Button id="verify-button" @click="startPasswordResetStep1"  :disabled="!areAllInputsGiven"> Continue </Button>
                </form>
                <p id="login-text"> Remembered Password <a href="#" @click.prevent="redirectToLogin"> login </a></p>
...
export default {
    ...
    methods: {
       ...
       async startPasswordResetStep1() {
           let ip = await this.getPublicIp()
           this.errorMessage = ""
           let myEmail = this.emailId;
           this.emailId = ""
           console.log(myEmail, ip, HOST)
           ...
           let apiPath = HOST + "/password/verifyemail"
           ...
           try {
                ...
                this.$router.push("/password_reset_email_verify_view");
