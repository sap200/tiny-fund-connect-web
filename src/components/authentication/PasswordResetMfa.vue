        ...
        <div id="left-pane">
            <div id="signup-form">
                ...
                <form id="signup-form-1" @submit.prevent>
                    ...
                    <Button id="signup-button" @click="verifyPasswordResetMfa" :disabled="isOtpEmpty"> Verify OTP </Button>
                </form>
...
export default {
    ...
    methods: {
       async verifyPasswordResetMfa() {
           ...
           let apiPath = HOST + "/password/completemfa"
           ...
           try {
                ...
                if (!response.ok) {
                    ...
                    if (responseData.message == "The MFA code is no longer valid" || responseData.message == "Authentication failed") {
                            this.$notify("OTP invalid, Another email is triggered")
                ...
                if (responseData.status == "SUCCESS") {
                    this.$notify("Password reset successfully")
                        ...
                        // Perform the redirection here
                                this.$router.push('/login_email_password_view') // Replace '/target-page' with your actual target route
